...
BENCHMARK_SAMPLE = {
    '160_80': ['160_15', '161_15', '162_15', ],
    '165_80': ['163_15', '164_15', '165_15', '166_15', '167_15', ],
    '170_80': ['168_15', '169_15', '170_15', '171_15', '172_15', ],
    '175_80': ['173_15', '174_15', '175_15', '176_15', '177_15', ],
    '180_80': ['178_15', '179_15', '180_15', '181_15', '182_15', ],
    '185_80': ['183_15', '184_15', '185_15', ],
}
...
def main():
    ...
    parameter_points = ['160_15', '172_15', '185_15', '160_80', '175_80', '185_80']
    ...
    if rerun_sample_augmenter:
        ...
        sa = SampleAugmenter(miner_h5_path_with_data)
        x_all, theta0_all, theta1_all, y_all, r_xz_all, t_xz_all = [], [], [], [], [], None
        for theta1_benchmark, theta0_benchmarks in BENCHMARK_SAMPLE.iteritems():
            train_filename = 'train_{}'.format(theta1_benchmark)
            x, theta0, theta1, y, r_xz, t_xz = sa.extract_samples_train_ratio(
                theta0=multiple_benchmark_thetas(theta0_benchmarks),
                theta1=constant_benchmark_theta(theta1_benchmark),
            ...
            y_all.append(y)
            r_xz_all.append(r_xz)

        # TODO: should we shuffle the arrays?
        np.save(path.join(tutorial_dir, 'data/samples/x_train.npy'), np.vstack(x_all))
        np.save(path.join(tutorial_dir, 'data/samples/theta0_train.npy'), np.vstack(theta0_all))
        np.save(path.join(tutorial_dir, 'data/samples/theta1_train.npy'), np.vstack(theta1_all))
        np.save(path.join(tutorial_dir, 'data/samples/y_train.npy'), np.vstack(y_all))
        np.save(path.join(tutorial_dir, 'data/samples/r_xz_train.npy'), np.vstack(r_xz_all))
        ...
        thetas_benchmarks, xsecs_benchmarks, xsec_errors_benchmarks = sa.extract_cross_sections(
            theta=multiple_benchmark_thetas([b.name for b in physics_benchmarks])
        )
